...
# Configure mysql
sleep 3 &&  sudo /etc/init.d/mysql stop
...
sudo chmod +x /vagrant/atlassian-confluence-6.2.1-x64.bin
yes "" | sudo /vagrant/atlassian-confluence-6.2.1-x64.bin
sleep 5 && sudo /etc/init.d/confluence stop
sudo rm /opt/atlassian/confluence/conf/server.xml
sudo cp ~/vagrant/server.xml /opt/atlassian/confluence/conf/server.xml
